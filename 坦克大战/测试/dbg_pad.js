...
;(function(){
  ...
  Input.pollGamepads();
  console.log("after poll: ui=", JSON.stringify(Input.ui), "state=", Game.state);
  Game.handleKeys();
  console.log("after handleKeys: menuSel=", Game.menuSel);
  Input.endFrame();
  pad.buttons[13].pressed=false;
  console.log("after endFrame: ui=", JSON.stringify(Input.ui));
})();
`;
