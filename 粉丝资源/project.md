...
- 测试 `测试/resources_test.js` 校验资源入口与详情页。
...
- 2026-09-09 完成 Mac 软件资源库全量建设后，于 2026-09-10 将其提升为根目录平级项目 `Mac软件资源库/`；该项目的页面、数据、测试与批处理约定均已随之迁出，本项目不再维护编号 `06`。
...
- Mac 软件资源库的专项 QA、交付记录和后续维护已迁往 `../Mac软件资源库/`，本项目不再保存或执行其专项测试。
