...
**Spec:** `docs/three-kingdoms-v0.1-spec.md`
...
- New card uses `data-game-version="three-kingdoms"` and links to `./three-kingdoms.html`.
...
- [ ] **Step 3: Add the new card.** Add an original copy block with the title `吞食天地：汉末群雄`, concise description, `GAME 002`, version fallback `v0.1.0 开发版`, and `href="./three-kingdoms.html"`. Keep the sponsor block and Tank Battle card unchanged.
...
- Create: `测试工具/three_kingdoms_test.js`
- Modify: `README.md`
- Modify: `文件夹说明.md`
...
```bash
node '测试工具/three_kingdoms_test.js' three-kingdoms.html
```
...
```bash
git add three-kingdoms.html '测试工具/three_kingdoms_test.js' README.md '文件夹说明.md'
...
- Modify: `测试工具/three_kingdoms_test.js`
...
```bash
git add three-kingdoms.html '测试工具/three_kingdoms_test.js'
...
- Catalog entry: id `three-kingdoms`, title `吞食天地：汉末群雄`, URL `./three-kingdoms.html`, version `v0.1.0`, status `稳定版` after the tag is present.
