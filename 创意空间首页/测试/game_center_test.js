...
assert.match(portal, /href=["']\.\.\/坦克大战\/tank-battle\.html["']/, '小游戏中心应链接到上级目录坦克大战创意下的 tank-battle.html');
assert.match(portal, /href=["']\.\.\/吞食天地三国\/three-kingdoms\.html["']/, '小游戏中心应链接到上级目录吞食天地三国创意下的 three-kingdoms.html');
